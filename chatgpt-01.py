...
name = st.text_input('시인의 이름을 입력하세요: ')
...
if button_result:
    ...
    with st.spinner('pleasw wait....'):
    
        # 메세지의 종류 세가지 : 시스템 메세지 , 유저 메세지 , AI 메세지
        result = openai.chat.completions.create(
            ...
            messages=[
                ...
                {
                    'role':'user',
                    'content': '작가의 이름은 ' + name
                },
                {
                    'role':'user',
                    'content': '시의 주제는 ' + subject
                },
                {
                    'role':'user',
                    'content': '시의 내용은 ' + content
                },
                {
                    'role':'user',
                    'content': '이 내용으로 시를 지어줘'
                }
            ]
        )
